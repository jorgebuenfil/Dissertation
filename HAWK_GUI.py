...
class Input_Image:
    ...
    def handle_tensorflow_single():
        Input_Image.tensorflow1(False, "Inception_v3")

    def handle_tensorflow_batch():
        Input_Image.tensorflow1(True, "Inception_v3")
    ...
    def tensorflow1(batch_operation=False, model="Inception_v3"):
        ...
        if model == "MobileNet":
            ...
            model_file  = BASE_DIRECTORY + "night_vision_output_graph.pb"
            labels_file = BASE_DIRECTORY + "night_vision_output_labels.txt"
    ...
    def face_detection():
        base     = "/home/jorge/workspace/OpenCV_projects/612-deep-learning-face-detection/"
        model    = base + "res10_300x300_ssd_iter_140000.caffemodel"
        prototxt = base + "deploy.prototxt.txt"
        dim      = (300, 300)
    ...
    def pi_surveillance():
        ...
        while True:
            ...
            B_image = Input_Image.ssd_pre_process_image(Beta_image)
            B_image, results = Input_Image.ssd_infer_image(B_image, Beta_image)
...
class App(tk.Frame):
    ...
    def __init__(self, master):
        ...
        main_window.title("HAWK Demo v.3 with Night Vision")
