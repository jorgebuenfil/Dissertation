...
python tensorflow/examples/image_retraining/retrain.py \
    --image_dir ~/Pictures/contraband_photos
```
...
```bash
python tensorflow/examples/image_retraining/retrain.py \
    --image_dir ~/Pictures/contraband_photos --architecture mobilenet_1.0_224
```
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='/home/jorge/Pictures/contraband_photos',
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/home/jorge/Downloads/temp/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='/home/jorge/Downloads/temp/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='/home/jorge/Downloads/temp/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/home/jorge/Downloads/temp/retrain_logs',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='/home/jorge/workspace/TensorFlow_Projects/tensorflow-for-poets-2/tf_files/models/Inception_v3/imagenet',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='/home/jorge/Downloads/temp/bottleneck',
